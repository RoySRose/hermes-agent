...
def build_context_files_prompt(
    ...
    # tree gain system-prompt authority. Configured external files remain
    # additive because they are explicitly trusted profile context.
    ...
    if (
        ...
        # Priority-based automatic context: first match wins. Avoid files already
        # loaded through context.external_files and honor ignore_hermes_md.
        project_context = (
            (
                ""
                if _context_ignores_hermes_md()
                else _load_hermes_md(cwd_path, context_length, external_paths)
            )
