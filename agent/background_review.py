...
_MEMORY_REVIEW_PROMPT = (
    ...
    "Routing discipline — where each finding belongs:\n"
    "- USER PROFILE: ONLY durable personal facts about the user as a person "
    "(identity, background, relationships, stable personal preferences/tastes).\n"
    "- Findings from point 2 — behavior expectations, reporting format, work "
    "style, operating rules, process/workflow constraints, tool or backend "
    "choices — must NOT be written to the user profile. Durable ones belong in "
    "the skill library (the separate skill review pass encodes them); keep at "
    "most a session-scoped note in agent memory. When unsure, do not write to "
    "the user profile.\n\n"
